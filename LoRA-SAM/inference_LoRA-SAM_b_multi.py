...
def get_available_ranks(weights_dir="./lora_weights"):
...
def main():
    # Load the baseline SAM model (using ViT-B)
    logger.info("Loading baseline SAM-B model...")
    ...
    print("Evaluating baseline SAM-B...")
    ...
    if not available_ranks:
        print("No LoRA weights found in ./lora_weights directory")
        return
    ...
    for rank in available_ranks:
        print(f"\nEvaluating LoRA-SAM-B with Rank {rank}...")
        try:
    ...
    csv_file = "./output_data/evaluation_results_sam_b_all_ranks.csv"
    ...
    plt.tight_layout()
    plt.savefig("./plots/comparison_plot_sam_b_all_ranks.jpg", bbox_inches='tight', dpi=300)
    print("Plot saved to ./plots/comparison_plot_sam_b_all_ranks.jpg")
